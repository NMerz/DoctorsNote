Use DoctorsNote;
DROP PROCEDURE FillReminder;
DELIMITER $$
CREATE procedure FillReminder(
  addInt INT
)
begin
  #counter
  ...
  WHILE counter <= addInt DO
    ...
    #Insert
    INSERT INTO DoctorsNote.Reminder(reminderID, content, remindedID, creatorID, timeCreated, alertTime)
    VALUES (my_reminderID, my_content, my_remindedID, my_creatorID, my_timeCreated, my_alertTime);
